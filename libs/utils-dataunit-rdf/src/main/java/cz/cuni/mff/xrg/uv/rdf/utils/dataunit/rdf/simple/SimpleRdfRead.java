...
public interface SimpleRdfRead {
    ...
    /**
     * Eagerly load all triples and store them into list. Do not use for larger number of triples.
     *
    ...
    /**
     * Execute given select query and return result. See {@link ConnectionPair} for more information about
     * usage.
     *
     ...
     * @throws OperationFailedException
     */
    ConnectionPair<TupleQueryResult> executeSelectQuery(String query) throws OperationFailedException;

    /**
     * Execute given construct query and return result. See {@link ConnectionPair} for more information about
     * usage.
     *
