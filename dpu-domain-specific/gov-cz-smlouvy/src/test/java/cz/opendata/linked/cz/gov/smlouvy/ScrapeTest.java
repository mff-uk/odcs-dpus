...
//        FileDataUnit smlouvy_roky = env.createFileOutput(
//                "XMLSmlouvy-RocniSeznam");
//        FileDataUnit objednavky_roky = env.createFileOutput(
//                "XMLObjednavky-RocniSeznam");
//        FileDataUnit plneni_roky = env.createFileOutput("XMLPlneni-RocniSeznam");
//        RDFDataUnit smlouvy_meta = env
//                .createRdfOutput("Smlouvy-Metadata", false);
//        RDFDataUnit objednavky_meta = env.createRdfOutput("Objednavky-Metadata",
//                false);
