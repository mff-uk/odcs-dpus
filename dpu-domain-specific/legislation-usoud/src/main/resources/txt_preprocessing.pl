...
while (<TXT_FILE>) {
    ...
    ## Pre US zacneme tlacit od USNESENI alebo CESKA REPUBLIKA
    if ($is_us and !$was_note and $_ =~ /(?:U S N E S E N|USNESEN|ROZSUDEK|.ESK. REPUBLIKA|.esk. republika|S t a n o v i s k o)/) {
        print STDERR "$line: ZACIATOK US\n";
        $was_note = 1;
    }
